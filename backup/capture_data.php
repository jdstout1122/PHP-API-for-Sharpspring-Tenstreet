<?php 
    if(!empty($_POST))
	{
		   $myfile = fopen("test_response_data.txt", "a") or die("Unable to open file!");
			...
			$curl_post['PersonalData']['PersonName']['GivenName'] = ($post['firstName'])?$post['firstName']:'NA';
			$curl_post['PersonalData']['PersonName']['FamilyName'] = ($post['lastName'])?$post['lastName']:'NA';
